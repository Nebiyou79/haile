...
const PaymentPage = () => {
  useEffect(() => {
    if (!document.getElementById("paypal-sdk")) {
      ...
      script.src = "https://www.paypal.com/sdk/js?client-id=BAAq7-TFe3eCyt6BsT9U2D_o1HjD7tNBGVoV4n1EutNAQiPKTW5qZQpyEv7f4QM_uC74BupDZcAiwwaoE8&components=hosted-buttons&enable-funding=venmo&currency=USD";
      ...
      <div className="flex flex-col md:flex-row md:justify-center items-center mt-16 p-6 md:p-12 bg-blue-500 min-h-screen">
        ...
        <div className="md:w-1/3 border border-gray-300 rounded-lg shadow-md bg-white p-8 md:mr-10 mb-8 md:mb-0">
          <div className="flex items-center mb-6">
            <Image src="/logo.png" alt="Company Logo" width={80} height={80} className="mr-4 rounded-lg" />
            <div>
              ...
              <a href="mailto:haile@fwl-cpa.com" className="block text-blue-600 hover:text-blue-800 mt-2 underline">
                haile@fwl-cpa.com
              </a>
              <p>
                <a href="tel:+17028159685" className="text-blue-600 hover:text-blue-800">(702) 815-9685</a>
              </p>
            </div>
          </div>
        ...
        <div className="md:w-2/3 border border-gray-300 rounded-lg shadow-md bg-white p-8">
          ...
          <form className="space-y-6">
            ...
            <div className="mt-8">
              ...
              <p className="text-gray-500 mb-4 text-sm">We currently accept online payments via PayPal only.</p>
              <div id="paypal-container-XAE73J99S657A" className="mt-4"></div>
            </div>
          </form>
        </div>
      </div>
